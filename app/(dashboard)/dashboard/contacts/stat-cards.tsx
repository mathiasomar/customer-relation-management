    ...
    <div className="w-full">
      {isFetching ? (
        ...
        <div className="my-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-accent p-4 rounded-lg shadow space-y-2">
          ...
          <div className="bg-accent p-4 rounded-lg shadow space-y-2">
            ...
            <p className="text-2xl font-bold text-primary">{stat?.active}</p>
          </div>
          <div className="bg-accent p-4 rounded-lg shadow space-y-2">
            <h3 className="text-sm text-gray-500">Inactive</h3>
            <p className="text-2xl font-bold text-primary">{stat?.inactive}</p>
          </div>
        </div>
      )}
    </div>
