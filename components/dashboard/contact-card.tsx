...
const ContactCard = ({ contactId }: { contactId: string }) => {
  const { data: contact, isFetching } = useContact(contactId);
  ...
  return (
    <>
      {isFetching ? (
        <Card>
          <CardContent className="h-50 flex flex-col items-center justify-center gap-6">
                ...
                <TooltipProvider>
                  <div className="flex items-center gap-3">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Opportunities: {contact?._count?.opportunities || 0}
                        </p>
                      </TooltipContent>
                    </Tooltip>
